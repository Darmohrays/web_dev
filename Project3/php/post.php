...
<html>
    ...
    <body>
        ...
        <div>
            <p style="color: white; display: table; margin: 0 auto"> Welcome <?php echo $_POST["name"]; ?><br></p>
            <p style="color: white; display: table; margin: 0 auto"> Your email address is: <?php echo $_POST["email"]; ?> </p>
        </div>
